...
ALTER TABLE convidados
  ...
  ADD COLUMN manual_role_title VARCHAR(80) DEFAULT NULL AFTER email,
  ADD COLUMN manual_role_text TEXT DEFAULT NULL AFTER manual_role_title,
  ADD COLUMN manual_sort_order SMALLINT UNSIGNED NOT NULL DEFAULT 1 AFTER manual_role_text,
